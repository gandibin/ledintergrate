          ...
          <div class="feedback">
            <form id="fm1" name="fm1" class="form-horizontal" method="post" action="{pboot:msgaction}" >
              <div class="form-group">
                <label for="contacts" class="col-sm-3 control-label">Name: </label>
                <div class="col-sm-6">
                  <input type="text" name="contacts" class="form-control" id="contacts" >
                </div>
              </div>
              <div class="form-group">
                <label for="contacts" class="col-sm-3 control-label">Tel: </label>
                <div class="col-sm-6">
                  <input type="text" name="mobile" class="form-control" id="mobile" >
                </div>
              </div>
              <div class="form-group">
                <label for="mobile" class="col-sm-3 control-label">Email: </label>
                <div class="col-sm-6">
              ...
              <div class="form-group">
                <label for="checkcode" class="col-xs-12 col-sm-3 control-label">CheckCode: </label>
			...
			function cheForm()
			{
			 ...
			 if(document.fm1.mobile.value=="") {
				...
				alert("Sorry, the mobile cannot be empty!");
				return false;
			  }
			  if(document.fm1.email.value=="") {
				document.fm1.email.focus();
				alert("Sorry, the email cannot be empty!");
				return false;
			  } 
			 if(document.fm1.content.value=="") {
				document.fm1.content.focus();
				alert("Sorry, please leave your valuable comments so that we can provide timely feedback.");
				return false;
			  }
			  };
...
<div class="loadjs"> 
  ...
  0 => 'D:/phpstudy_pro/WWW/xingwei2.com/template/en/head.html',
  1 => 'D:/phpstudy_pro/WWW/xingwei2.com/template/en/nybanner.html',
  2 => 'D:/phpstudy_pro/WWW/xingwei2.com/template/en/foot.html',
); ?>