...
<div class="wrapper">
  <div class="wrap wrap-contact">
    <div class="container">
      <div class="contact">
        <div class="text wow fadeInLeft" data-wow-duration="1s"> <b>{pboot:companyname}</b>
          <p class="tel">Tel : {pboot:companyphone}</p>
          <p class="email">E-mail : <a href="mailto:{pboot:companyemail}">{pboot:companyemail}</a></p>
          <p class="tel">M-Phone : {pboot:companymobile}</p>
          <p class="fax">Fax : {pboot:companyfax}</p>
          <p class="address">Address : {pboot:companyaddress}</p>
        </div>
        <div class="pic wow fadeInRight" data-wow-duration="1s"> <img src="{sort:ico}" title="contact us" alt="contact us" /> </div>
      </div>
    </div>
  </div>
</div>
