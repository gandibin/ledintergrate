      ...
      {/pboot:nav}
        ...
        <div class="wrap-right wow fadeInRight" data-wow-duration="1s">
          <div class="product-show">
            ...
            <div class="detail">
              <div class="title-detail"> <b>产品详情</b> </div>
...
<div class="relate">
   <ul>
      ...
      <li class="prev"><a href="{content:prelink}" title="{content:pretitle}">上一篇: {content:pretitle notext='没有了'}</a></li>
      <li class="next"><a href="{content:nextlink}" title="{content:nexttitle}">下一篇: {content:nexttitle notext='没有了'}</a></li>
...
<script>
  ...
  2 => 'D:/phpstudy_pro/WWW/xingwei2.com/template/cn/nav.html',
  3 => 'D:/phpstudy_pro/WWW/xingwei2.com/template/cn/prevnext.html',
  4 => 'D:/phpstudy_pro/WWW/xingwei2.com/template/cn/foot.html',
); ?>